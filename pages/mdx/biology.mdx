...
<u>ref1</u>. These microRNAs circulate in the blood, and can be shown to be either upregulated, or downregulated
in certain conditions. The dysregulation of these diseases can be linked to developmental stages of diseases <u>
	ref2
</u> and by using toehold switches, which have binding sites for the upregulated miRNA we can detect
the disease. While our system is meant to be modular, we have chosen endometriosis, PCOS, ovarian cancer
and breast cancer to prove the theory. Given we needed 3 miRNA for each disease we have chosen the following,
