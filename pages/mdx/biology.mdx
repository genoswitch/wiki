...
<ul>
	...
	<li>
		miRNA-19b-3p<Reference number={7}/>
	</li>
	<li>
...
environments<Reference number={14}/>.
Within Genoswitch, we use microRNA as a biomarker to indicate when a specific blood environment,
brought about by a certain disease, occurs<Reference number={15}/>.
When the miRNA is sufficiently upregulated, the ribosome binding site for the various fluorescent
...
switches and <u>less than</u>2.25M concentrations of miRNAs<Reference number={16}/>. We therefore needed to amplify
