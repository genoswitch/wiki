...
of an expensive thermocycler. More information on the probes used can be found on our <u>
	Software Page
</u>
...
<u>ref2</u>. These microRNAs circulate in the blood, and can be shown to be either upregulated,
or downregulated in certain conditions. The dysregulation of these diseases can be linked to developmental
stages of diseases <u>ref2</u> and by using toehold switches, which have binding sites for the upregulated miRNA we can detect the disease.
