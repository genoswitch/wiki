        ...
        return (
            <>
                <ThemeProvider theme={theme}>
                    <div style={{
                        filter: "drop-shadow(18px 18px 20px rgba(0, 0, 0, 0.5))", backgroundColor: "#0a1628", border: "none", color: "white", borderRadius: "20px"
                    }}>
                        <Card style={{ position: "relative" }}>
                            {/** cardMedia */}
                            <GatsbyImage alt={`$${this.props.card.name} header image`} image={image} style={{
                                position: "absolute",
                                width: "100%",
                                maxHeight: "50vh",
                                objectFit: "cover",
                            ...
                            <CardContent sx={{ paddingTop: "30vh" }}>
                                <Typography sx={{ textAlign: "center", letterSpacing: "10px" }} className="cardHeader" gutterBottom variant="h2" component="div">
