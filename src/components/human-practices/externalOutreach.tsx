	...
	const atHomeTestingRefs: ReferenceType[] = [
		{
			...
			title: "Can self-testing increase HIV testing among men who have sex with men: A systematic review and meta-analysis",
			...
			<Card raised>
				<Box sx={{ width: "100%" }}>
					...
					<CustomTabPanel value={value} index={1}>
						...
						in the hope that it would increase the uptake of our tests.
						By creating home-testing kits, we aim to be able to periodically test for conditions to detect them at a
						much earlier stage as well (as increase the uptake of patients for these tests). In other situations where
						at-home testing is employed, results are promising. The National Institute for Health and Care Research
						conducted an RCT for at home testing for HIV and found that HIV self-testing increased overall HIV test
						frequency by one extra test over a six-month time period (95% CI 0.52 to 1.24) and resulted in more
						first-time testers as for 9.9% of the participants this was their first test (95% CI 7.4 to 13.8). <Reference number={1} /> Recently,
						the NHS has implemented a program whereby bowel cancer self-testing kits are sent to those eligible,
						which has seen the proportion of people choosing to participate in bowel screening has increased to
						70.3% – the highest on record. <Reference number={2} /> Evidence from a US study surrounding cervical cancer (similarly under
						screened and prone to late diagnosis to endometriosis) showed, in a CRT, that Screening uptake was
						72% among women who received mailed self-testing kits compared to 37% for the other group of
						women. Home-screening “puts women in control” and can “better reach people without access to
						screening” according to study co-author Noel T. Brewer.

						Currently the NHS offers at-home testing through the company MonitorMyHealthThe company sends a
						test pack to homes and offers a wide range of tests, all using capillary blood collection <Reference number={3} /> via a finger prick.
						The capillary tests offered by MonitorMyHealth collect either 600 or 250µl of blood <Reference number={4} /> . However, capillary
						blood tests can collect up to 1 ml of blood meaning if more blood was needed in order to detect
						sufficient numbers of miRNA for our project there is a possibility of developing a further blood test. It is
						important to note that given restricted time in the labs we aren’t able to determine the precise critical
						value for the number of miRNA that need to be present in order for a positive test so the true feasibility
						of at-home testing cannot be determined, although the proposal does offer exciting scope for future
						development.
						<br />
