			...
			<HeaderFooterProvider>
				<Container>
					...
					<h2>Monday 17th July 2023</h2>
						...
						With these solutions, we created our agar plates and left them to cool and solidify.
					...
					<h2>Thursday 20th July 2023</h2>
						...
						We found that the DNA that we ordered was linear and did not have four random nucleotides on its ends. 
						As a result, the restriction sites were too close to the end which made it difficult for restriction enzymes to “break” the restriction sites. 
						This meant that we would have to use primers to add onto the ends of our sequences and turn our linear DNA into plasmids using a plasmid backbone.
						Today, we used a mass spectrometer to measure the growth of our E. Coli, based on its optical density in respect to the density of the media alone (the LB Broth).
						The spectrometer detects absorbance 600 Nanometres.
					...
					<h2>Monday 21st August 2023</h2>
						...
						Due to logistical issues regarding our orders and lab availability, not much was done in the month prior to our return to the labs.
						...
						Once this was completed, we conducted electrophoresis on our DNA at 100W for about 1 hour.
						Once finished, we were able to analyse our trays using UV light.
						You can find the full protocol for electrophoresis and PCR in our Protocols page.
							// Biology Protocols Page - Please add hyperlink to the Biology Protocols page (with text as above).
