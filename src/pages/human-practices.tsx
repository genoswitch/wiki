		...
		return (
			<HeaderFooterProvider>
				<Container>
					...
					that the symptoms that they face are real. By producing a more efficient tool for diagnosis, we hope that the unnecessary suffering that patients go through whilst waiting
					for a diagnosis would be minimised. 
					<br/>
					We also hope that by increasing education in these
					...
					<br/>
					We envision that our tool would be used by phlebotomy departments in Integrated Care Systems
