	...
	return (
		<Box sx={{ width: "100%" }}>
			...
			<CustomTabPanel value={value} index={1}>
				...
				for a high number of follicles in your ovary) and a blood test (testing for low FSH levels).
			...
			<CustomTabPanel value={value} index={2}>
				...
				<ul>
					<li>
						Those with a family history of breast, ovarian, endometrial or colorectal cancer (Those
						with BRCA1 and BRCA2 gene mutations).
					</li>
				...
				<h4 style={{ paddingTop: 4 }}>Current Diagnostic Method:</h4>A blood test and scans are done
				first, but other tests are needed to diagnose ovarian cancer. Whilst Ultrasounds, CT scans,
				laparoscopies and laparotomies are commonly used, a biopsy is the only definitive way to
